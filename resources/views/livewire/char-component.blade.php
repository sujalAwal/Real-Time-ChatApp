...
<div style="overscroll-behavior: none;">
    ...
    <div class="mt-20 mb-16">
     ...
     @if ($oneMsg['sender_name'] == $user->name)
     <div class="clearfix w-4/4">
      <div class="text-left">

        <p
        class="bg-gray-300 mx-4  p-2 rounded-lg inline-block"
        >{{$oneMsg['message']}}  <span class=" text-purple-500 px-3">{{$oneMsg['time']->format('g:i a')}}
        </span>
      </p>
      </div>
    </div>
     ...
     @else{
      <div class="clearfix w-4/4">
        <div class="text-right">
          ...
          <p
          class="bg-green-300 mx-4  p-2 rounded-lg inline-block"
          >{{$oneMsg['message']}}  <span class=" text-purple-500 px-3">{{$oneMsg['time']->format('g:i a')}}</p>
        </div>
      </div>
